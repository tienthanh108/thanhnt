# Dream PreLaunch Application
Check out https://suspicious.website/2016/04/29/starting-out-with-react-redux-starter-kit/ to understand the project structure. 
...
```bash
$ git clone <project_url> <my-project-name>
$ cd <my-project-name>
```
...
## Install haproxy using homebrew for reverse proxy
