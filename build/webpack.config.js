...
webpackConfig.module.loaders.push(
  ...
  { test: /\.png(\?.*)?$/,   loader: 'url?prefix=fonts/&name=[path][name].[ext]&limit=1&mimetype=image/png+xml' },
  { test: /\.jpg(\?.*)?$/,   loader: 'url?prefix=fonts/&name=[path][name].[ext]&limit=1&mimetype=image/jpg+xml' },
  { test: /\.gif(\?.*)?$/,   loader: 'url?prefix=fonts/&name=[path][name].[ext]&limit=1&mimetype=image/gif+xml' }
)
/* eslint-enable */
