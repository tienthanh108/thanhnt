...
(function ($, undef) {
  ...
  $.fn.dotdotdot = function (o) {
    ...
    let opts = $.extend(true, {}, $.fn.dotdotdot.defaults, o),
      conf = {},
      watchOrg = {},
      watchInt = null,
      $inr = null
  ...
  function ellipsis($elem, $d, $i, o, after) {
    ...
    const notx = 'a, table, thead, tbody, tfoot, tr, col, colgroup, object, embed, param, ol, ul, dl, blockquote, select, optgroup, option, textarea, script, style'

        //	Don't remove these elements even if they are after the ellipsis
    const noty = 'script, .dotdotdot-keep'
  ...
  function ellipsisElement($e, $d, $i, o, after) {
    ...
    if (o.maxLength) {
      ...
      if (position != -1 && !(textArr.length === 1 && textArr[0].length === 0)) {
        ...
        const afterLength = (after && after.closest($w).length) ? after.length : 0
...
jQuery(document).ready(($) => {
  ...
  $('.dot-ellipsis').each(function () {
    ...
    const watch_window = $(this).hasClass('dot-resize-update')

        // Checking if update on timer required
    const watch_timer = $(this).hasClass('dot-timer-update')
